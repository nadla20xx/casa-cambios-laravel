...
<body >
    ...
    <div class="pagina">
        <section class="seccion-pagina parte-superior">
            <div class="contenedor-parte-superior">
                ...
                <ul class="formulario-compra-venta" id="formulario-compra-venta">
    ...
    var app = new Vue({
        ...
        created: function () {
            ...
            //this.lectura = this.NuevaLectura();
            this.RecuperarTipoCambioHoy();
        },
        methods: {
